        ...
        function () {
            ...
            Route::group(['middleware' => 'verified'], function () {
                ...
                if (Jetstream::hasApiFeatures()) {
                    Route::get('/user/api-tokens', [ApiTokenController::class, 'index'])->name(
                        'api-tokens.index',
                    );
                    Route::post('/user/api-tokens', [ApiTokenController::class, 'store'])->name(
                        'api-tokens.store',
                    );
                    ...
                    Route::delete(
                        ...
                        [ApiTokenController::class, 'destroy'],
                ...
                if (Jetstream::hasTeamFeatures()) {
                    ...
                    Route::put('/teams/{team}', [TeamController::class, 'update'])->name(
                        'teams.update',
                    );
                    Route::delete('/teams/{team}', [TeamController::class, 'destroy'])->name(
                        'teams.destroy',
                    );
                    Route::put('/current-team', [CurrentTeamController::class, 'update'])->name(
                        'current-team.update',
                    );
                    ...
                    Route::delete(
                        '/team-invitations/{invitation}',
                        [TeamInvitationController::class, 'destroy'],
                    )
