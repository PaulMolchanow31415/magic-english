...
var e = String.prototype.replace, r = /%20/g, n = 'RFC3986', o = {
  ...
  }, p = Array.isArray, h = String.prototype.split, y = Array.prototype.push,
  d = function(t4, e2) {
    y.apply(t4, p(e2) ? e2 : [e2])
  }, b = Date.prototype.toISOString, g = o.default, v = {
    addQueryPrefix: false, allowDots: false, charset: 'utf-8', charsetSentinel: false, delimiter: '&', encode: true, encoder: f.encode, encodeValuesOnly: false, format: g, formatter: o.formatters[g], indices: false, serializeDate: function(t4) {
      return b.call(t4)
    }, skipNulls: false, strictNullHandling: false,
  }, m = function t3(e2, r2, n2, o2, i2, u2, a2, s2, c2, l2, y2, b2, g2, m2) {
    var j2, w2 = e2
    ...
    for (var T2 = 0; T2 < R2.length; ++T2) {
      var k2 = R2[T2],
        C = 'object' == typeof k2 && void 0 !== k2.value ? k2.value : w2[k2]
      if (!i2 || null !== C) {
    ...
    return x2
  }, j = Object.prototype.hasOwnProperty, w = Array.isArray,
  $ = { allowDots: false, allowPrototypes: false, arrayLimit: 20, charset: 'utf-8', charsetSentinel: false, comma: false, decoder: f.decode, delimiter: '&', depth: 5, ignoreQueryPrefix: false, interpretNumericEntities: false, parameterLimit: 1e3, parseArrays: true, plainObjects: false, strictNullHandling: false },
  O = function(t4) {
    ...
    if (t4) {
      var o2 = r2.allowDots ? t4.replace(/\.([^.[]+)/g, '[$1]') : t4,
        i2 = /(\[[^[\]]*])/g, u2 = r2.depth > 0 && /(\[[^[\]]*])/.exec(o2),
        a2 = u2 ? o2.slice(0, u2.index) : o2, s2 = []
      if (a2) {
      ...
      return u2 && s2.push('[' + o2.slice(u2.index) + ']'), function(t5, e3, r3, n3) {
        for (var o3 = n3 ? e3 : E(e3, r3), i3 = t5.length - 1; i3 >= 0; --i3) {
          ...
          if ('[]' === a3 && r3.parseArrays) {
            ...
            var s3 = '[' === a3.charAt(0) && ']' === a3.charAt(a3.length - 1) ? a3.slice(1, -1) : a3,
              f3 = parseInt(s3, 10)
    ...
    for (var n2 = 'string' == typeof t4 ? function(t5, e3) {
      var r3, n3 = {},
        o3 = (e3.ignoreQueryPrefix ? t5.replace(/^\?/, '') : t5).split(e3.delimiter, Infinity === e3.parameterLimit ? void 0 : e3.parameterLimit),
        i3 = -1, u3 = e3.charset
      ...
      for (r3 = 0; r3 < o3.length; ++r3) {
        if (r3 !== i3) {
          var a3, s3, c2 = o3[r3], l2 = c2.indexOf(']='),
            p2 = -1 === l2 ? c2.indexOf('=') : l2 + 1;
...
class x {
  ...
  matchesUrl(t4) {
    ...
    const e2 = this.template.replace(/(\/?){([^}?]*)(\??)}/g, (t5, e3, r3, n3) => {
      ...
      }).replace(/^\w+:\/\//, ''), [r2, n2] = t4.replace(/^\w+:\/\//, '').split('?'),
      o2 = new RegExp(`^${e2}/?$`).exec(decodeURI(r2))
    if (o2) {
...
createServer(
  (page) => createInertiaApp({
    ...
    resolve: (name) => resolvePageComponent(`./Pages/${name}.vue`, /* @__PURE__ */ Object.assign({
      './Pages/API/Index.vue': () => import('./assets/Index-CvjkVUec.js'), './Pages/API/Partials/ApiTokenManager.vue': () => import('./assets/ApiTokenManager-rJWQ0AK2.js'), './Pages/Auth/ConfirmPassword.vue': () => import('./assets/ConfirmPassword-CIsoL7VI.js'), './Pages/Auth/ForgotPassword.vue': () => import('./assets/ForgotPassword-B4tCXHeI.js'), './Pages/Auth/Login.vue': () => import('./assets/Login-aA5On3UA.js'), './Pages/Auth/Register.vue': () => import('./assets/Register-Br5E3a6M.js'), './Pages/Auth/ResetPassword.vue': () => import('./assets/ResetPassword-D8kgOlFh.js'), './Pages/Auth/TwoFactorChallenge.vue': () => import('./assets/TwoFactorChallenge-Cx0loZsS.js'), './Pages/Auth/VerifyEmail.vue': () => import('./assets/VerifyEmail-WM6QtuG5.js'), './Pages/Dashboard.vue': () => import('./assets/Dashboard-pnLjovTl.js'), './Pages/PrivacyPolicy.vue': () => import('./assets/PrivacyPolicy-Dvn5U9K1.js'), './Pages/Profile/Partials/DeleteUserForm.vue': () => import('./assets/DeleteUserForm-C5mKAfCX.js'), './Pages/Profile/Partials/LogoutOtherBrowserSessionsForm.vue': () => import('./assets/LogoutOtherBrowserSessionsForm-DEKK9Osz.js'), './Pages/Profile/Partials/TwoFactorAuthenticationForm.vue': () => import("./assets/TwoFactorAuthenticationForm-B5iVxYHB.js"), "./Pages/Profile/Partials/UpdatePasswordForm.vue": () => import("./assets/UpdatePasswordForm-COC4KMkW.js"), "./Pages/Profile/Partials/UpdateProfileInformationForm.vue": () => import("./assets/UpdateProfileInformationForm-zzk2BceD.js"), "./Pages/Profile/Show.vue": () => import("./assets/Show-064jn_2X.js"), "./Pages/TermsOfService.vue": () => import("./assets/TermsOfService-CQ3A1TXK.js"), "./Pages/Welcome.vue": () => import("./assets/Welcome-fw4BC0B8.js")
    })),
