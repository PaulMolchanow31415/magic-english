...
return [
    ...
    */
    ...
    'digits'               => 'Поле атрибута : должно быть :digits цифры.',
    ...
    'gte'                  => [
        'array'   => 'Поле :атрибут должно содержать :элементов значения или более.',
        'file'    => 'Поле :атрибут должно быть больше или равно : килобайтам значения.',
        'numeric' => 'Поле :Атрибут должно быть больше или равно :значению.',
        'string'  => 'Поле :атрибут должно быть больше или равно :символам значения.',
    ],
    ...
    'lowercase'            => 'Поле атрибута : должно быть в нижнем регистре.',
    'lt'                   => [
    ...
    'password'             => [
        'letters'       => 'Поле :атрибут должно содержать по крайней мере одну букву.',
        'mixed'         => 'Поле :атрибут должно содержать по крайней мере одну заглавную и одну строчную букву.',
        'numbers'       => 'Поле :атрибут должно содержать по крайней мере одно число.',
        'symbols'       => 'Поле :атрибут должно содержать по крайней мере один символ.',
        'uncompromised' => 'Указанный атрибут : появился в результате утечки данных. Пожалуйста, выберите другой атрибут :.',
    ],
    ...
    'same'                 => 'Поле атрибута : должно соответствовать :other.',
    'size'                 => [
        'array'   => 'Поле :атрибут должно содержать :элементы размера.',
        'file'    => 'Поле :атрибут должно быть :размер в килобайтах.',
        'numeric' => 'Поле :атрибут должно быть :размер.',
        'string'  => 'Поле :атрибут должно быть :размер символов.',
    ],
