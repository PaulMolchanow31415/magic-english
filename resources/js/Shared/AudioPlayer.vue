    ...
    >
      ...
      >
        ...
        <div class="items-center justify-center hidden me-auto md:flex">
          <img class="h-12 me-3 rounded" :src="state.singer.poster_url" :alt="state.singer.name" />
      ...
      <div v-show="isShowCapture" class="bg-white border-t border-gray-200">
        <div class="max-h-72 pt-4 pb-6 overflow-y-scroll text-center" v-html="state.song?.lyrics" />
      </div>
    </div>
  </Teleport>
</template>
