...
<template>
  <div class="flex items-center">
    ...
    >
      <Icon :icon="['fas', 'minus']" class="w-3 h-3 text-gray-900 dark:text-white" />
    </button>
    <input
      v-model="proxyValue"
      type="number"
    ...
    <button @click="proxyValue++" type="button" class="number-input-button rounded-e-lg">
      <Icon :icon="['fas', 'plus']" class="w-3 h-3 text-gray-900 dark:text-white" />
    </button>
  </div>
</template>
...
.number-input-button {
  ...
  hover:bg-gray-200 border border-gray-300 p-3 h-11 focus:ring-gray-100
